...
bool SpriteSheet::Load(const std::string& name)
{
	...
	bool loadedSpriteSections = LoadSpritesSections(App::Singleton().GetBasePath() + std::string("Assets/") + name + ".txt");
...
bool SpriteSheet::LoadSpritesSections(const std::string& path)
{
